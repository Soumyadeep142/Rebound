...
for t in year:
	j+=1
	sim.integrate(t)
	fig,ax_main=rebound.OrbitPlot(sim, xlim=(-7*10**9,7*10**9), ylim=(-7*10**9,7*10**9), unitlabel='km', color=['grey','pink',"blue","red",'orange','yellow','white','green','cyan'], orbit_type='solid', fancy='true')
